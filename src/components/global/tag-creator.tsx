...
const TagCreator = ({ getSelectedTags, defaultTags, subAccountId }: Props) => {
  ...
  return (
    <AlertDialog>
      <Command className="br-transparent">
        {!!selectedTags.length && (
          <div className="flex flex-wrap gap-2 p-2 bg-transparent border-2 border-border rounded-md">
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-left">
                      This action cannot be undone. This will permantely delete
